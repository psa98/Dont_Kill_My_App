...
public class CustomPriorityTimer {
    ...
    public CustomPriorityTimer() {
         ...
         */
        public CustomPriorityTimer(boolean isDaemon, int priority) {
            this("Timer-" + serialNumber(), isDaemon,priority);
        }
         ...
         * @since 1.5
         */
        public CustomPriorityTimer(String name, int priority) {
            thread.setName(name);
         ...
         * @since 1.5
         */
        public CustomPriorityTimer(String name, boolean isDaemon, int priority) {
            thread.setName(name);
